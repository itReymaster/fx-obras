  ...
  for (const row of baseRows) {
    await prisma.constructionOpportunity.upsert({
      ...
      update: {
        ...
        constructionType: row.constructionType as any,
        constructionStage: row.constructionStage as any,
        commercialPotential: row.commercialPotential as any,
        addressSource: row.addressSource as any,
      },
      create: {
        ...row,
        status: row.status as any,
