...
const erpFlexHost = stripWrappingQuotes(
  process.env.ERP_FLEX_SQLSERVER_HOST ?? process.env.DB_HOST ?? process.env.SQLSERVER_HOST,
);
const erpFlexPort = stripWrappingQuotes(
  process.env.ERP_FLEX_SQLSERVER_PORT ?? process.env.DB_PORT ?? process.env.SQLSERVER_PORT,
);
const erpFlexDatabase = stripWrappingQuotes(
  process.env.ERP_FLEX_SQLSERVER_DATABASE ?? process.env.DB_DATABASE ?? process.env.SQLSERVER_DATABASE,
);
const erpFlexUsername = stripWrappingQuotes(
  process.env.ERP_FLEX_SQLSERVER_USERNAME ?? process.env.DB_USER ?? process.env.SQLSERVER_USERNAME,
);
const erpFlexPassword = stripWrappingQuotes(
  process.env.ERP_FLEX_SQLSERVER_PASSWORD ?? process.env.DB_PASSWORD ?? process.env.SQLSERVER_PASSWORD,
);
